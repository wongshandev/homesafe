...
/* ADD-E 20120417 FOR CMMBCAS2GPP*/
		...
		HS_JAVA_STORE_INTERNAL_TIMER,
		HS_JAVA_STORE_INTERNAL_TIMER_MAX = HS_JAVA_STORE_INTERNAL_TIMER + 50,
		HS_JAVA_STORE_PLATFORM_TIMER,
		HS_JAVA_STORE_PLATFORM_TIMER_MAX = HS_JAVA_STORE_PLATFORM_TIMER + 50,
#endif 

#ifdef __MMI_LMW_SUPPORT__
    LC_LMW_TIMER,
    LC_LMW_TIMER_MAX = LC_LMW_TIMER + 100,
#endif /* __MMI_LMW_SUPPORT__ */

#if defined(__MMI_FLASHLIGHT_APP__)
    NEW_MSG_LIGHT_TIMER,
    FIGHTLIGHT_TIMER_EVT,
#endif   
    ...
    DESKPET_TIMER_EVT,
     ...
     TIMER_ID_LFY_BASE,
     TIMER_ID_LFY_END = TIMER_ID_LFY_BASE + 20,
#endif
#ifdef __B321_MMI_SUBLCD__
	SUBLCD_SLEEP_EVT,
#endif
