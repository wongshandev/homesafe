...
#    COMMINCDIRS  +=  inet_ps\xdm\include
#    COMP_TRACE_DEFS  +=  inet_ps\xdm\include\xdm_trc.h
#  endif
#endif
...
ifdef MSDC_CARD_SUPPORT_TYPE
  ifneq ($(strip $(MSDC_CARD_SUPPORT_TYPE)),NONE)
    MSDC_SUPPORT_PLATFORM = MT6217 MT6218B MT6219 MT6228 MT6229 MT6230 MT6226 MT6227 MT6226M MT6225 MT6253T MT6253 MT6251 MT6252 MT6252H MT6253E MT6253L MT6227D MT6226D MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6270A MT6256 MT6276 MT6921 MT6255 MT6922 MT6250
...
BLUETOOTH_SUPPORT_CHIP = BTMTK_MT6601 BTMTK_MT6611 BTMTK_MT6612 BTMTK_MT6236 BTMTK_MT6256 BTMTK_MT6276 BTMTK_MT6616 BTMTK_MT6622 BTMTK_MT6626 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6612_22 BTMTK_MT6612_26 BTMTK_MT6622_26 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250
# NONE, BTMTK, BTMTK_MT6601, BTMTK_MT6611, BTMTK_MT6612, BTMTK_MT6236, BTMTK_MT6256, BTMTK_MT6276, BTMTK_MT6616 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250
  ...
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifeq ($(filter $(strip $(BLUETOOTH_SUPPORT)),$(BLUETOOTH_SUPPORT_CHIP)),)
      ifneq ($(strip $(BT_SPP_SERVER)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250,BT_SPP_SERVER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(BT_SPP_CLIENT)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250,BT_SPP_CLIENT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    ...
    ifeq ($(strip $(BT_BPP_PROFILE)),TRUE)
      ...
      BT_SUPPORT_PROFILE += BT_BPP_PROFILE
    endif
...
HORIZONTAL_CAMERA_SUPPORT_SIZE = 176X220 240X320 240X400 320X480 360X640 480X800
...
ifeq ($(strip $(COLOR_SUBLCD)), TRUE)
	COM_DEFS  += COLOR_SUBLCD
endif
...
ifeq ($(strip $(MMI_VERSION)),COSMOS_MMI)
  ifdef UNIFIED_MESSAGE_ADVANCE_FEATURE
    ifeq ($(findstring COMPOSER,$(strip $(UNIFIED_MESSAGE_ADVANCE_FEATURE))),)
        $(call DEP_ERR_ONA_OR_OFFB,COMPOSER in UNIFIED_MESSAGE_ADVANCE_FEATURE)
        DEPENDENCY_CONFLICT = TRUE
    endif
...
SV5_PLATFORM = MT6276 MT6256 MT6251 MT6573 MT6255 MT6922 MT6250
...
ifeq ($(strip $(MMI_VERSION)),COSMOS_MMI)
  ifneq ($(strip $(SQLITE3_SUPPORT)),TRUE)
    $(call DEP_ERR_SETA_OR_SETB,SQLITE3_SUPPORT,TRUE,MMI_VERSION,non COSMOS_MMI)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ifeq ($(strip $(MMI_VERSION)),COSMOS_MMI)
   COM_DEFS += __CPI_SUPPORT__ __SS_OPERATION_SUPPORT__
   COM_DEFS += __MED_IN_ASM__
   COM_DEFS += DISABLE_MODIS_THEME_EDITOR
endif
...
ifdef CMMB_SUPPORT
  ifneq ($(strip $(CMMB_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(CMMB_DATA_SERVICE_SUPPORT)),TRUE)
      COM_DEFS    += __CMMB_DS_SUPPORT__
    endif
...
ifdef MEDIA_PLAYER_VER
  ...
  ifeq ($(strip $(MMI_VERSION)),COSMOS_MMI)
    ifneq ($(strip $(MEDIA_PLAYER_VER)),COSMOS_MUSIC_PLY)
      $(call DEP_ERR_SETA_OR_SETB,MEDIA_PLAYER_VER,COSMOS_MUSIC_PLY,MMI_VERSION,non COSMOS_MMI)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifeq ($(strip $(WIFI_BT_SINGLE_ANTENNA_SUPPORT)),TRUE)
  ifeq ($(strip $(WIFI_SUPPORT)),MT5921)
    BT_SINGLE_ANTENNA_SUPPORT_CHIP = BTMTK_MT6612 BTMTK_MT6616 BTMTK_MT6236 BTMTK_MT6276 BTMTK_MT6256 BTMTK_MT6255 BTMTK_MT6921 BTMTK_MT6922 BTMTK_MT6250
...
ifneq ($(strip $(YUVCAM_INTERPOLATION)),NONE)
  YUVCAM_INTERPOLATION_SUPPORT_PLATFORM = MT6235 MT6235B MT6253 MT6253E MT6253L MT6252 MT6252H MT6250
...
ifdef GADGET_SUPPORT
  ifneq ($(strip $(GADGET_SUPPORT)),NONE)
    ...
    ifneq ($(strip $(DEMO_PROJECT)),TRUE)
      ifeq ($(strip $(YAHOO_CONTENT_SUPPORT)),FALSE)
        ifeq ($(strip $(FACEBOOK_CONTENT_SUPPORT)),FALSE)
          $(call DEP_ERR_ONA_OR_OFFB,YAHOO_CONTENT_SUPPORT\FACEBOOK_CONTENT,GADGET_SUPPORT)
          DEPENDENCY_CONFLICT = TRUE
        endif
      endif
    endif
...
ifdef CMMB_CAS_MBBMS_SUPPORT
  ifeq ($(strip $(CMMB_CAS_MBBMS_SUPPORT)),TRUE)
    ...
    ifeq ($(strip $(MBBMS_VERSION)),3.0)
      ...
      ifeq ($(strip $(CMMB_DATA_SERVICE_SUPPORT)),FALSE)
        $(call DEP_ERR_SETA_OR_ONB,MBBMS_VERSION,2.0,CMMB_DATA_SERVICE_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
  endif
...
ifneq ($(filter MT6236% MT6252% MT6921 MT6256 MT6255 MT6922 MT6250,$(PLATFORM)),)
...
ifdef COMBO_MEMORY_SUPPORT
  ifeq ($(strip $(COMBO_MEMORY_SUPPORT)),TRUE)
    ifneq ($(filter MT6251% MT6252% MT6276% MT6235% MT6236% MT6268% MT6253% MT6256% MT6255% MT6922% MT6250%,$(PLATFORM)),)
      COM_DEFS    += __COMBO_MEMORY_SUPPORT__
    else
      $(warning ERROR: COMBO_MEMORY_SUPPORT = TRUE just can be supported on MT6251/MT6252/MT6276/MT6235/MT6236/MT6268/MT6253/MT6256/MT6255/MT6922/MT6250.)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef INPUT_METHOD
  INPUT_METHOD_FREE_LIBRARIES = NONE MMI_CSTAR_V2_DEMO MMI_CSTAR_FREE_SLIM_0K MMI_CSTAR_FREE_SLIM_5K MMI_CSTAR_FREE_SLIM_10K MMI_CSTAR_FREE_FULL
  ifeq ($(filter $(INPUT_METHOD_FREE_LIBRARIES),$(strip $(INPUT_METHOD))),)
    ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
      ifeq ($(strip $(EMPTY_RESOURCE)),TRUE)
        $(warning ERROR: Please set INPUT_METHOD to NONE/MMI_CSTAR_V2_DEMO/MMI_CSTAR_FREE_SLIM_0K/MMI_CSTAR_FREE_SLIM_5K/MMI_CSTAR_FREE_SLIM_10K/MMI_CSTAR_FREE_FULL in customer projects.)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
  endif
...
# Release four free libraries to customers.
  ifneq ($(findstring MMI_CSTAR,$(strip $(INPUT_METHOD))),)
 ...
 # block 2 can be released
  ...
  ifeq ($(strip $(INPUT_METHOD)),MMI_GUOBI_V1)
    COMPLIST    += guobi
    COMMINCDIRS  += vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v1_demo\inc
    COMPOBJS   +=   vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v1_demo\lib\guobi.a
    CUS_REL_OBJ_LIST   += vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v1_demo\lib\guobi.a
    CUS_INPUTMETHOD_BASE   = vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v1_demo
    COM_DEFS    += MMI_GUOBI
  ...
  ifeq ($(strip $(INPUT_METHOD)),MMI_GUOBI_V5_2)
    COMPLIST    += guobi
    COMMINCDIRS  += vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v5_2_demo\inc
    COMPOBJS   +=   vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v5_2_demo\lib\_libGBEngine_.a
    CUS_REL_OBJ_LIST   += vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v5_2_demo\lib\_libGBEngine_.a
    CUS_INPUTMETHOD_BASE   = vendor\InputMethod\GUOBI\project\$(strip $(INPUT_METHOD_BASE))\v5_2_demo
    COM_DEFS    += MMI_GUOBI
    COM_DEFS    += __MMI_GUOBI__
    CUSTOM_COMMINC += $(strip $(CUS_INPUTMETHOD_BASE))\inc
    CUS_REL_BASE_COMP   += $(strip $(CUS_INPUTMETHOD_BASE))\lib
  ...
  ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
    ifneq ($(strip $(INPUT_METHOD)),NONE)
      ifeq ($(findstring KOMOXO,$(strip $(INPUT_METHOD))),)
...
SYNC_LCM_HW_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6253T MT6253 MT6516 MT6270A MT6256 MT6276 MT6253E MT6253L MT6252 MT6252H MT6921 MT6255 MT6922 MT6250
...
ifdef VIBRATION_SPEAKER_SUPPORT 
  VIBRATION_SPEAKER_SUPPORT_PLATFORM = MT6252 MT6250
...
ifeq ($(strip $(DCM_COMPRESSION_SUPPORT)),TRUE)
  ...
  ifeq ($(strip $(SECURE_SUPPORT)),TRUE)
    $(warning ERROR: when SECURE_SUPPORT is set to TRUE , DCM_COMPRESSION_SUPPORT cannot be enabled .)
    DEPENDENCY_CONFLICT = TRUE
  endif
...
MDP_MULTIPLE_DISPLAY_BUFFER_PLATFORM = MT6253 MT6253T MT6253E MT6253L MT6253PMU MT6252 MT6252H MT6235 MT6268 MT6236 MT6276 MT6256 MT6255 MT6250 MT6922
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6255 MT6250
...
ifeq ($(strip $(DEMO_PROJECT)),TRUE)
  ifeq ($(strip $(MMI_FEATURES_SWITCH)),FALSE)
    ifeq ($(strip $(YAHOO_CONTENT_SUPPORT)),FALSE)
      $(warning ERROR: Please enable YAHOO_CONTENT_SUPPORT on internal project)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(FACEBOOK_CONTENT_SUPPORT)),FALSE)
      $(warning ERROR: Please enable FACEBOOK_CONTENT_SUPPORT on internal project)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef BES_EQ_SUPPORT
  ifeq ($(strip $(BES_EQ_SUPPORT)),TRUE)
    EQ_FLEX_SUPPORT_PLATFORM = MT6268 MT6236 MT6276 MT6255 MT6256 MT6250
...
ifeq ($(strip $(MOT_SUPPORT)),TRUE)
  ifneq ($(strip $(SQLITE3_SUPPORT)),TRUE)
    $(call DEP_ERR_ONA_OR_OFFB,SQLITE3_SUPPORT,MOT_SUPPORT)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ifeq ($(strip $(CARDAV_SUPPORT)),TRUE)
  ...
  ifeq ($(strip $(CLOUD_SUPPORT)),FALSE)
    $(call DEP_ERR_SETA_OR_OFFB,CLOUD_SUPPORT,TRUE,CARDAV_SUPPORT)
    DEPENDENCY_CONFLICT = TRUE
  endif
...
ifdef CLOUD_SUPPORT
ifeq ($(strip $(CLOUD_SUPPORT)),TRUE)
  COM_DEFS    += __CLOUD_SUPPORT__
  ifeq ($(strip $(VCARD_CLOUD_SUPPORT)),FALSE)
    ifeq ($(strip $(SMS_CLOUD_SUPPORT)),FALSE)
      $(warning ERROR: please turn on VCARD_CLOUD_SUPPORT or SMS_CLOUD_SUPPORT when CLOUD_SUPPORT = TRUE)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
else
  ifeq ($(strip $(VCARD_CLOUD_SUPPORT)),TRUE)
    $(warning ERROR: please turn off VCARD_CLOUD_SUPPORT when CLOUD_SUPPORT = FALSE)
    DEPENDENCY_CONFLICT = TRUE
  endif
  ifeq ($(strip $(SMS_CLOUD_SUPPORT)),TRUE)
    $(warning ERROR: please turn off SMS_CLOUD_SUPPORT when CLOUD_SUPPORT = FALSE)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
endif
...
ifeq ($(strip $(MULTIPLE_BINARY_FILES)),TRUE)
    ifeq ($(strip $(ZIMAGE_SUPPORT)),TRUE)
        ifeq ($(strip $(ZIMAGE_FAVOR_ROM)),TRUE)
          $(call DEP_ERR_OFFA_OR_OFFB,MULTIPLE_BINARY_FILES,ZIMAGE_FAVOR_ROM)
          DEPENDENCY_CONFLICT = TRUE
        endif
    endif
endif
...
ifdef BLUETOOTH_SUPPORT
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifeq ($(call gt, $(strip $(BT_SUPPORT_PROFILE_NUM)), $(BT_SUPPORT_PROFILE_MAX_NUM)),T)
      $(error ERROR: BT at most supports $(BT_SUPPORT_PROFILE_MAX_NUM) profiles on LOW_COST_SUPPORT project, currently already $(BT_SUPPORT_PROFILE_NUM) BT profiles:$(BT_SUPPORT_PROFILE))
      DEPENDENCY_CONFLICT = TRUE
    endif
...
ifdef DUAL_CAMERA_CUSTOM
  ifneq ($(strip $(DUAL_CAMERA_CUSTOM)),FALSE)
    COM_DEFS    += DUAL_CAMERA_CUSTOM
  endif
endif

ifneq ($(strip $(BREATH_LIGHT_SUPPORT)), NONE)
  COM_DEFS  += BREATH_LIGHT_TASK
  COM_DEFS  += BREATH_LIGHT_SUPPORT
  COM_DEFS  += BREATH_LIGHT_IC_$(strip $(BREATH_LIGHT_SUPPORT))
endif
...
#NMI TV Series
ifdef NMI_TV_SUPPORT	
  ifneq ($(strip $(NMI_TV_SUPPORT)),NONE)
    ifeq ($(strip $(NMI_TV_SUPPORT)),NMI_60X)
			COM_DEFS    += __NMI_TV_SUPPORT__	
			#COM_DEFS    += NMI_SCAN_USE_TASK
			
			COM_DEFS    += __NMI_FM_SUPPORT__ 
			COM_DEFS	+= FM_RADIO_ENABLE
			ifdef FM_RADIO_RECORD
				ifeq ($(strip $(FM_RADIO_RECORD)),TRUE)
					COM_DEFS  += FM_RADIO_RECORD
			...
			#COM_DEFS	+= __NMI_TV_RECORDER__
	

			
			COMPLIST += nmi60x
			CUS_REL_SRC_COMP  += nmi60x
			LINK_COMPLIST += nmi60x
    endif
  endif
endif
#### Begin JavaStore   __MMI_JAVA_STORE__   ###########################
ifeq ($(strip $(HS_JAVA_STORE_SUPPORT)),TRUE)
	COM_DEFS += __MMI_JAVA_STORE__
  COM_DEFS += __MMI_JAVA_STORE_ENABLE_STANDARD_MENU__

# Enable WIFI
	ifeq ($(strip $(HS_JAVA_ENABLE_WIFI)),TRUE)
		COM_DEFS += __MMI_JAVA_STORE_ENABLE_WIFI__
	endif
	
# Enable Java run in background
	ifeq ($(strip $(HS_JAVA_ENABLE_RUN_IN_BACKGROUND)),TRUE)
		COM_DEFS += __MMI_JAVA_STORE_ENABLE_RUN_IN_BACKGROUND__
	endif

	ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),QWERTY)
		COM_DEFS += JAVA_KEY_PAD_QWERTY
	else ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),NORMAL)
		COM_DEFS += JAVA_KEY_PAD_NORMAL
	else
		COM_DEFS += JAVA_KEY_PAD_EMPTY
	endif

# Enable Java download manager
	COM_DEFS += __MMI_JAVA_STORE_ENABLE_DOWNLD_MANAGER__
# Enable Java download dic
	ifeq ($(strip $(HS_JAVA_STORE_DLD_DIC)),TRUE)
		COM_DEFS += __MMI_JAVA_STORE_ENABLE_DOWNLD_DIC__
		ifeq ($(strip $(HAND_WRITING)),NONE)
			$(warning ERROR: please set HAND_WRITING  or turn off HS_JAVA_STORE_DLD_DIC) 
			DEPENDENCY_CONFLICT = TRUE
		endif	
	endif	
# Enable MENU_DESKTOP
	ifeq ($(strip $(HS_JAVA_STORE_MENU_DESKTOP)),TRUE)
		COM_DEFS += __MMI_JAVA_STORE_MENU_DESKTOP__
	endif
# Enable SUPPORT_Vkeyboard
	ifneq ($(strip $(TOUCH_PANEL_SUPPORT)),NONE)
		ifeq ($(strip $(HS_JAVA_STORE_VKEYBOARD_ENABLE)),TRUE)
			ifeq ($(strip $(MAIN_LCD_SIZE)),240X320)
				ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),NO_KEYPAD)
					COM_DEFS += __HS_JAVA_VIRTUAL_KEYBOARD_SUPPORT__
					COM_DEFS += _HS_JAVA_VK_FLOAT__
				endif
			endif
			ifeq ($(strip $(MAIN_LCD_SIZE)),240X400)
				COM_DEFS += __HS_JAVA_VIRTUAL_KEYBOARD_SUPPORT__
				COM_DEFS += _HS_JAVA_VK_COMBINED__
			endif
			ifeq ($(strip $(MAIN_LCD_SIZE)),320X480)
				COM_DEFS += __HS_JAVA_VIRTUAL_KEYBOARD_SUPPORT__
				COM_DEFS += _HS_JAVA_VK_EMBEDDED__ #_HS_JAVA_VK_FLOAT__
			endif
		endif
	endif
#High quality
	ifeq ($(strip $(HS_JAVA_STORE_VKEYBOARD_ENABLE)),TRUE)
		ifeq ($(strip $(MAIN_LCD_SIZE)),320X480)
		COM_DEFS += __HS_JAVA_APP_HIGH_QUALITY__
		COM_DEFS += __JAVA_APP_UC_BROWSER__#UC浏览器
		COM_DEFS += __JAVA_APP_NETWORK_BOOKSTORE__#网络书城
		COM_DEFS += __JAVA_APP_EVERYONE_NETS__#人人网
		COM_DEFS += __JAVA_APP_QQ__#QQ
		COM_DEFS += __JAVA_APP_MARKET_NETS__#赶集网
		COM_DEFS += __JAVA_APP_HAPPY_NET__#开心网
		COM_DEFS += __JAVA_APP_POWERWORD__#金山词霸
		COM_DEFS += __JAVA_APP_WISDOM__#大智慧
		COM_DEFS += __JAVA_APP_NETEASE_MAIL__#网易手机邮
		COM_DEFS += __JAVA_APP_FLIGHT_STEWARD__#航班管家
		COM_DEFS += __JAVA_APP_FANTASY_THREE__#幻想三国
		COM_DEFS += __JAVA_APP_CHINESE_CHESS__#中国象棋
		COM_DEFS += __JAVA_APP_INTERSTELLAR_PURSUIT__#星际追击
		COM_DEFS += __JAVA_APP_STAR_BOWLING__#明星保龄球
		COM_DEFS += __JAVA_APP_ASSASSINS_CREED2__#刺客信条2
		COM_DEFS += __JAVA_APP_ARMED_BIRDS__#武装飞鸟之爆裂空战
		COM_DEFS += __JAVA_APP_ANTITERRORISM_PIONEER__#反恐先锋之超人联手蝙蝠侠
		COM_DEFS += __JAVA_APP_BATTLESHIP_2010__#战列舰2010
		COM_DEFS += __JAVA_APP_DEMON_CAME__#魔域降临之黑暗奇兵
		COM_DEFS += __JAVA_APP_SONIC_BOY__#音速小子大跳跃
		endif
	endif
# Support  JSSDS(Java Store Smart Desktop Support)
	ifeq ($(strip $(HS_JAVA_STORE_SMART_DESKTOP_SUPPORT)),TRUE)
		COM_DEFS += __MMI_JAVA_STORE_SMART_DESKTOP_SUPPORT__
	endif
	
# Add compile module
	COMPLIST += javastore
	CUS_REL_SRC_COMP += javastore
	
# Add hmobilcore library
	HS_OPTION_COMPILER = ads
	
	ifeq ($(strip $(HS_JAVA_TARGET_COMPILER)),ARM_RVCT)
		HS_OPTION_COMPILER = rvct
	endif
	
	HS_OPTION_VM_TYPE = mi
	
	ifeq ($(strip $(HS_JAVA_STORE_VM_TYPE)),VM_TN)
		HS_OPTION_VM_TYPE = tn
		COM_DEFS += __MMI_JAVA_STORE_ENABLE_TINY_VER__
	else
		ifeq ($(strip $(HS_JAVA_STORE_VM_TYPE)),VM_MI)
			HS_OPTION_VM_TYPE = mi
		else
			ifeq ($(strip $(HS_JAVA_STORE_VM_TYPE)),VM_SL)
				HS_OPTION_VM_TYPE = sl
			else		
					HS_OPTION_VM_TYPE = st
			endif
		endif
	endif
		
	COMPOBJS += plutommi\mmi\JavaStore\Release\lib\hmobilecore_$(HS_OPTION_COMPILER)_$(HS_OPTION_VM_TYPE).lib
	
# Add library
	COMPOBJS += plutommi\mmi\JavaStore\Release\lib\hsjavastore_$(HS_OPTION_COMPILER).lib
	
# add Java download manager libray
	COMPOBJS += plutommi\mmi\JavaStore\Release\lib\hdownld_$(HS_OPTION_COMPILER).lib

# add Java virtual keyboard  libray
	ifneq ($(strip $(TOUCH_PANEL_SUPPORT)),NONE)
		ifeq ($(strip $(HS_JAVA_STORE_VKEYBOARD_ENABLE)),TRUE)
#			COMPOBJS += plutommi\mmi\JavaStore\Release\lib\hsvkeyboard_$(HS_OPTION_COMPILER).lib
		endif
	endif
	
ifeq ($(strip $(HS_JAVA_STORE_VM_TYPE)),VM_TN)
	COMPOBJS += plutommi\mmi\JavaStore\Release\lib\dloader_$(HS_OPTION_COMPILER).lib
endif

ifeq ($(strip $(HS_JAVA_SMALL_VERSION)),TRUE)
	COM_DEFS += __MMI_JAVA_STORE_SMALL_VERSION__
	COM_DEFS += __MMI_LC_MMS__ 
	
 # GPRS Profile for WAP2.0(HTTP)
	COM_DEFS += WAP2 
  ...
  ifdef XML_SUPPORT
	...
	COMPOBJS += plutommi\mmi\JavaStore\Release\lib\hsmmscore_$(HS_OPTION_COMPILER).lib
endif

	#ifeq ($(strip $(LC_LMW_PLATFORM_SUPPORT)),TRUE)

		COM_DEFS += __MMI_LMW_SUPPORT__
     
		#11B1212时使用此宏，并且不要注释掉LC_LMW_MTK_SW_VER_11B1132
		ifeq ($(strip $(MMI_VERSION)),COSMOS_MMI)
			COM_DEFS += __MMI_LMW_COSMOS_SUPPORT__
		endif

		#COM_DEFS += LC_LMW_MTK_SW_VER_09A0952
		#COM_DEFS += LC_LMW_MTK_SW_VER_09B1012
		#COM_DEFS += LC_LMW_MTK_SW_VER_10A1108
		COM_DEFS += LC_LMW_MTK_SW_VER_11B1132
	
		LC_LMW_PLATFORM_DEBUG = FALSE   ################begin	
		LC_LMW_RELEASE_TYPE = PLATFORM_PORTING		 
		LC_LMW_KEYPAD_TYPE = AUTO	 
		LC_LMW_SHARE_MEM = TRUE
		LC_LMW_VIRTUAL_KEYPAD_SUPPORT = TRUE 
		LC_LMW_APP_RUNNING_MODE = SINGLE_APP  #################end
				
	    LC_LMW_PRODUCT_TYPE = release
	    
ifeq ($(strip $(HS_JAVA_STORE_SUPPORT)),TRUE)
	COM_DEFS += LC_LMW_JAVA_SMART_SHOW_SUPPORT	
endif
	    ifeq ($(strip $(LC_LMW_PLATFORM_DEBUG)),TRUE)
	        COM_DEFS += __MMI_LMW_DEBUG__
	        LC_LMW_PRODUCT_TYPE = debug
	    endif
	
		#Add hmobilcore library

		#LC_LMW_OPTION_COMPILER = ads
		LC_LMW_OPTION_COMPILER = rvct31
	
	
	    ifeq ($(strip $(LC_LMW_RELEASE_TYPE)),PLATFORM_CORE)
	        COMPLIST += lmw
	        CUS_REL_SRC_COMP += lmw
	        COM_DEFS += __LMW_RELEASE_PLATFORM_CORE__
	    else
		    ifeq ($(strip $(LC_LMW_RELEASE_TYPE)),PLATFORM_PORTING)
	            COMPLIST += lmw
	            CUS_REL_SRC_COMP += lmw
	            COMPOBJS += plutommi\mmi\lmw\lib\$(LC_LMW_PRODUCT_TYPE)\lmw_core_$(LC_LMW_OPTION_COMPILER).a

	         	ifneq ($(strip $(HS_JAVA_STORE_SUPPORT)),TRUE)
					COMPOBJS += plutommi\mmi\lmw\lib\$(LC_LMW_PRODUCT_TYPE)\lmw_component_$(LC_LMW_OPTION_COMPILER).a
	         	endif
	
	            COM_DEFS += __LMW_RELEASE_PLATFORM_PORTING__
	        else
	            COMPOBJS += plutommi\mmi\lmw\lib\$(LC_LMW_PRODUCT_TYPE)\lmw_$(LC_LMW_OPTION_COMPILER).a
	            COM_DEFS += __LMW_RELEASE_APP__
	        endif
	    endif
	
	    ifeq ($(strip $(LC_LMW_KEYPAD_TYPE)),AUTO)
	        COM_DEFS += LC_LMW_KEYPAD_AUTO
	    else ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),QWERTY)
	        COM_DEFS += LC_LMW_KEYPAD_QWERTY
	    else ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),NORMAL)
	        COM_DEFS += LC_LMW_KEYPAD_NORMAL
	    else ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),REDUCED)
	        COM_DEFS += LC_LMW_KEYPAD_REDUCED
	    else ifeq ($(strip $(HS_JAVA_KEY_PAD_TYPE)),EXTEND_QWERTY)
	        COM_DEFS += LC_LMW_KEYPAD_EXTEND_QWERTY
	    else
	        COM_DEFS += LC_LMW_KEYPAD_EMPTY
	    endif

    # Enable SUPPORT_Vkeyboard
    ifneq ($(strip $(TOUCH_PANEL_SUPPORT)),NONE)
        ifeq ($(strip $(HS_JAVA_STORE_VKEYBOARD_ENABLE)),TRUE)#当JAVA关闭时请去除此判断
            ifeq ($(strip $(LC_LMW_VIRTUAL_KEYPAD_SUPPORT)),TRUE)
                ifeq ($(strip $(MAIN_LCD_SIZE)),240X320)
                    ifeq ($(strip $(LC_LMW_KEYPAD_TYPE)),NO_KEYPAD)
                        COM_DEFS += __MMI_LMW_VIRTUAL_KEYPAD_SUPPORT__
                        COM_DEFS += __LMW_VK_FLOAT__
                    endif
                endif
                ifeq ($(strip $(MAIN_LCD_SIZE)),240X400)
                   COM_DEFS += __MMI_LMW_VIRTUAL_KEYPAD_SUPPORT__
                   COM_DEFS += __LMW_VK_COMBINED__
                endif
                ifeq ($(strip $(MAIN_LCD_SIZE)),320X480)
                    COM_DEFS += __MMI_LMW_VIRTUAL_KEYPAD_SUPPORT__
                    COM_DEFS += __LMW_VK_EMBEDDED__ 
                endif
                ifeq ($(strip $(MAIN_LCD_SIZE)),480X800)
                    COM_DEFS += __MMI_LMW_VIRTUAL_KEYPAD_SUPPORT__
                    COM_DEFS += __LMW_VK_EMBEDDED__
                    COM_DEFS += __LMW_VK_EMBEDDED_WVGA__
                endif
            endif
        endif
    endif	
    # SUPPORT_Vkeyboard
		...
		ifneq ($(strip $(HS_JAVA_STORE_SUPPORT)),TRUE)
			ifeq ($(strip $(LC_LMW_SHARE_MEM)),TRUE)
				COM_DEFS += __MMI_JAVA_STORE_SHARE_MEM__
			endif
		endif	#HS_JAVA_STORE_SUPPORT
	
		COM_DEFS += __MMI_LMW_ENABLE_ADD_DTCNT__
		

	    ifeq ($(strip $(LC_LMW_APP_RUNNING_MODE)),SINGLE_APP)
	        COM_DEFS += __MMI_LMW_SINGLE_APP_MODE__
	    endif

	#endif  LC_LMW_PLATFORM_SUPPORT

endif
#### End JavaStore   __MMI_JAVA_STORE__   ###########################

ifeq ($(strip $(LEIFAYU_EXP)), TRUE)
  COM_DEFS += __LEIFAYU__
endif
