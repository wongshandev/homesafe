...
#if defined(TK6516) || defined(MT6516) || defined(__DATA_CARD_SPEECH__) || (defined(__SMART_PHONE_MODEM__) && defined(__DSP_FCORE4__))
   AUDIO_SAP,
#endif /* TK6516 || MT6516 */
...
typedef enum {
   ...
   MSG_ID_MMI_VS_MUTEX,
     ...
     MSG_ID_LFY_BASE,
     MSG_ID_LFY_END = MSG_ID_LFY_BASE + 30,
#endif
#if defined(BREATH_LIGHT_TASK)
  MSG_ID_BREATH_LIGHT_START,
  MSG_ID_BREATH_LIGHT_STOP,
#endif
   MSG_ID_END,
