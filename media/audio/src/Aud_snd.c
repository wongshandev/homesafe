 ...
 *  void
 *****************************************************************************/
static kal_int32 aud_snd_play_req(kal_uint8 output_path, kal_uint8 volume, kal_int16 repeats)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    AUD_VALUE_TRACE(snd_status, -1, __LINE__);
...
void aud_snd_play_byte_stream_req_hdlr(ilm_struct *ilm_ptr)
{
    ...
    play_result = aud_snd_play_req(msg_p->output_path, msg_p->volume, msg_p->repeats);
