...
#include "Uart_sw.h"
#if defined (__PS_SERVICE__)// && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)
#include "mmi_l3_enums.h"
#endif // ~ #if defined (__PS_SERVICE__) && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)
...
#include "l4c2uem_struct.h"             /* rtc_format_struct */
...
/* for PHB LN */
#define NVRAM_EF_PHB_LN_SIZE 10    //should move to nvram_common_defs.h
//#endif 
#if defined(__WS_HOME_SAFE__)
#define NVRAM_HF_DATA_LID_VERNO  		   "000"
#endif
...
#ifdef SLIM_WAP_MMS
#define NVRAM_WAP_PROF_URL_LEN 128
#else
...
#define NVRAM_EF_CACHE_SHORT_LID_VERNO       "001"
...
#define NVRAM_EF_AUDIO_PARAM_LID_VERNO                  "007"
...
#define NVRAM_EF_THEMES_VALUES_VERNO                    "002"
...
#define NVRAM_EF_MOBILE_TV_PLAYER_SETTING_LID_VERNO     "006"
...
#endif
#endif
#define NVRAM_EF_ABM_PS_QOS_PROFILE_LID_VERNO           "001"
...
#define NVRAM_EF_FM_RADIO_LID_VERNO                     "002"
...
#define NVRAM_EF_AUDIO_BESLOUDNESS_LID_VERNO            "001"
...
#define NVRAM_EF_EONS_INFO_LID_VERNO                    "001"
...
#define NVRAM_EF_DTCNT_APP_INFO_LID_VERNO               "001"
#define NVRAM_EF_WLAN_PROFILE_LID_VERNO                 "003"
#define NVRAM_EF_WLAN_SETTING_LID_VERNO                 "003"
...
#define NVRAM_EF_RAC_PREFERENCE_LID_VERNO               "004"
...
#define NVRAM_EF_BRW_USER_DEFINED_HOMEPAGE_LID_VERNO    "000"
#define NVRAM_EF_PUSH_SETTING_LID_VERNO                 "000"
#define NVRAM_EF_DRM_SETTING_LID_VERNO                  "001"
#define NVRAM_EF_DRM_STIME_LID_VERNO                    "001"
#define NVRAM_EF_DRM_CERPATH_LID_VERNO                  "000"
...
#define NVRAM_EF_GIS_GPS_SETTING_DATA_LID_VERNO         "000"
...
#define NVRAM_EF_VIDEO_NETWORK_PROFILE_LID_VERNO        "003"
...
#define NVRAM_EF_TIME_SYNC_SETTING_LID_VERNO            "000"
...
#define NVRAM_EF_AGPS_SEND_LOCATION_LID_VERNO           "000"
...
//#ifndef __PHB_NO_CALL_LOG__
#define NVRAM_EF_CHIST_MISS_ACCUM_TIMES_LID_VERNO       "000"
#define NVRAM_EF_CHIST_MISS_EVENT_CHECK_LID_VERNO       "000"
//#endif /* __PHB_NO_CALL_LOG__ */
...
#define NVRAM_EF_TCM_EXT_CALL_HISTORY_LID_VERNO               "000"
#endif // ~ #if defined (__PS_SERVICE__) && defined (__MOD_TCM__) && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)

#define  NVRAM_EF_VRE_PKEY_LIST_EXT_LID_VERNO  "001"
#define  NVRAM_EF_VRE_APP_BAN_LIST_EXT_LID_VERNO  "001"
#define  NVRAM_EF_VRE_SYM_ENTRY_LIST_EXT_LID_VERNO "001"
#define  NVRAM_EF_VRE_SYM_CONF_LIST_EXT_LID_VERNO "001"
#define  NVRAM_EF_VRE_FIRST_RUNNING_LID_VERNO "001"
...
#define NVRAM_EF_VENUS_3D_MM_LID_VERNO                "000"  // hongxi add
#define NVRAM_EF_VENUS_PHOTO_FILEPATH_LID_VERNO     "000"
#ifdef __TCPIP__
#define NVRAM_EF_CBM_CALL_HISTORY_LID_VERNO             "002"
#endif
...
#define NVRAM_TLG_JOYVE_INFO_LID_VERNO "001"
#ifdef TLG_1180_CHIP
#define NVRAM_TLG_JOYVE_DTV_INFO_LID_VERNO "001"
#define NVRAM_TLG_JOYVE_DTV_SERVICE_INFO_LID_VERNO "001"
#define NVRAM_TLG_JOYVE_ATV_SERVICE_INFO_LID_VERNO "001"
#endif
#endif
...
#define NVRAM_EF_OPERA_ADP_PROF_SETTING_LID_VERNO   "002"
#endif
...
#define NVRAM_EF_DTCNT_PROF_APP_INFO_LID_VERNO      "000"
...
#define NVRAM_EF_ATV_PLAYER_SETTINGS_LID_VERNO      "000"
#define NVRAM_EF_ATV_PLAYER_CHANNEL_LID_VERNO       "000"
#endif
...
/*
* Audio Parameter, refer to "audio_param_struct"
*/
typedef struct
{
...
typedef struct
{
    kal_uint32 nvram_ef_phb_group_field;
} nvram_ef_phb_group_field_struct;
...
typedef struct
{
    ...
    kal_uint64    call_history_last_ext_tx_data[MAX_EXT_PDP_CONTEXT]; 
    kal_uint64    call_history_last_ext_rx_data[MAX_EXT_PDP_CONTEXT]; 
    kal_uint64    call_history_total_ext_conn_duration; 
    kal_uint32    call_history_last_ext_conn_duration[MAX_EXT_PDP_CONTEXT]; 
} nvram_ef_tcm_ext_call_history_struct;
#endif // ~ #if defined (__PS_SERVICE__) && defined (__MOD_TCM__) && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)
...
/* Mobile TV Player App [Vincent Cho] */
typedef struct
{
...
typedef struct
{
    kal_uint8 nvram_wpss_filename[NVRAM_EF_WALLPAPER_FILENAME_SIZE];
...
typedef struct
{
    ...
    kal_uint32 net_id;               /* active data account or bearer */
...
typedef struct
{
    ...
    kal_uint8 proxy_addr[VIDEO_PORXY_IP_COUNT];
...
typedef struct
{
    ...
    kal_uint32 data_account_id; 
    kal_int32 proxy_port;
    kal_uint8 proxy_addr[MMI_MEDPLY_PROXY_IP_COUNT];
    kal_uint8 proxy_on_off;
    kal_int32 highest_udp_port;
    kal_int32 lowest_udp_port;       
...
typedef struct
{
    kal_uint8 nvram_ef_langln_lk_settings[NVRAM_EF_LANGLN_LK_SETTING_SIZE];
}nvram_ef_langln_lk_setting_struct;
#endif /*__MMI_LANGLN_LK__*/

typedef struct
{
    kal_uint8 nvram_ef_langln_presel_info[NVRAM_EF_LANGLN_PRESEL_INFO_SIZE];
}nvram_ef_langln_presel_info_struct;

#if defined(__MMI_LANGLN_SK__) || defined (__MMI_LANGLN_BK__)
typedef struct
{
    kal_uint8 nvram_ef_langln_sk_setting[NVRAM_EF_LANGLN_BSK_SETTING_SIZE];
}nvram_ef_langln_sk_setting_struct;
...
typedef struct
{
    kal_uint8 nvram_ef_gis_gps_setting_data[NVRAM_EF_GIS_GPS_SETTING_DATA_SIZE];
}nvram_ef_gis_gps_setting_data_struct;

typedef struct
{
    kal_uint8 nvram_ef_time_sync_setting[NVRAM_EF_TIME_SYNC_SETTING_SIZE];
}nvram_ef_time_sync_setting_struct;
...
typedef struct
{
    kal_uint8 accumu_times[NVRAM_EF_CHIST_MISS_ACCUM_TIMES_SIZE];
}nvram_ef_chist_miss_accum_times_struct;

typedef struct
{
    kal_uint8 check_status[NVRAM_EF_CHIST_MISS_EVENT_CHECK_SIZE];
}nvram_ef_chist_miss_event_check_struct;
...
typedef struct 
{
    kal_uint64 tcp_last_session_t; 
    kal_uint64 tcp_last_session_r;
    kal_uint64 tcp_last_session_time;
    kal_uint64 tcp_total_session_t;
    kal_uint64 tcp_total_session_r;
    kal_uint64 tcp_total_session_time;
}nvram_ef_cbm_tcp_history_struct;
#endif
#ifdef __DM_LAWMO_SUPPORT__
typedef struct
{
...
} nvram_ef_app_info_struct;

typedef struct
{
    kal_uint32 acct_id;
    kal_uint8 ap_num;                  /* valid ap id numbers in app_id array */
    nvram_ef_app_info_struct app_id[ABM_MAX_APP_NUM]; /* the subscribed ap list  */
}nvram_ef_dtcnt_app_info_list_struct;


typedef struct
{
    kal_uint32 acct_num;
    nvram_ef_dtcnt_app_info_list_struct acct_app_list;
}nvram_ef_dtcnt_app_info_nvram_struct;

typedef struct
{
	kal_uint8 acct_1; /* not need to initial with CBM_INVALID_NWK_ACCT_ID */
	kal_uint8 acct_2; /* not need to initial with CBM_INVALID_NWK_ACCT_ID */
	kal_uint16 str_id;
	kal_uint16 icon_id;
} nvram_dtcnt_app_acct_info_struct;

typedef struct
{
	nvram_dtcnt_app_acct_info_struct app_info[ABM_MAX_APP_NUM];
} nvram_dtcnt_prof_app_info_struct;
...
typedef struct
{
    kal_uint8 nvram_ef_opera_adp_prof_setting[NVRAM_EF_OPERA_ADP_PROF_SETTING_SIZE];
...
#if !defined(EMPTY_MMI) && !defined(EXTERNAL_MMI)
	 LID_BIT VER_LID(NVRAM_EF_SETTING_LID)
     nvram_setting_struct *NVRAM_SETTING_TOTAL
     {
...
#if !defined(EMPTY_MMI) && !defined(EXTERNAL_MMI)
LID_BIT VER_LID(NVRAM_EF_CALL_TIME_LID)
     nvram_call_time_struct *NVRAM_CALL_TIME_RECORD_TOTAL
     {
     };
#endif /* !defined(EMPTY_MMI) && !defined(EXTERNAL_MMI) */
...
/* Video App */
 ...
 #ifdef __MMI_PHOTOEDITOR__
/* Photo Editor App */
     LID_BIT VER_LID(NVRAM_EF_PHOTO_EDITOR_SETTING_LID)
     nvram_ef_photo_editor_setting_struct *NVRAM_EF_PHOTO_EDITOR_SETTING_TOTAL
     {
     };
 #endif /* __MMI_PHOTOEDITOR__ */ 
...
LID_BIT VER_LID(NVRAM_EF_PHB_VIP_CONTACT_LID)
     mmi_phb_vip_contact_struct *NVRAM_EF_PHB_VIP_CONTACT_TOTAL
     {
     };
...
#if !defined(EMPTY_MMI) && !defined(EXTERNAL_MMI)
#ifndef __MMI_PHB_NO_GROUP__
LID_BIT VER_LID(NVRAM_EF_PHB_GROUP_FIELD_LID)
     nvram_ef_phb_group_field_struct *MMI_PHB_GROUP_FIELD_TOTAL
     {
     };

LID_BIT VER_LID(NVRAM_EF_PHB_GROUP_INFO_LID)
     mmi_phb_group_info_struct *MMI_PHB_GROUP_COUNT
     {
     };
#endif /* __MMI_PHB_NO_GROUP__ */
...
LID_BIT VER_LID(NVRAM_EF_CAMERA_PARA_LID)
     ...
     {
     #if (!((defined(DRV_ISP_6225_SERIES) || defined(DRV_ISP_6235_SERIES)) && defined(__CAMERA_NVRAM_REDUCTION__)))
     ...
     #endif /* (!defined(DRV_ISP_6219_SERIES)) */ 
       AE:"AE"
         {
         };
...
LID_BIT VER_LID(NVRAM_EF_CAMERA_GAMMA_LID)
     nvram_camera_gamma_struct *NVRAM_EF_CAMERA_GAMMA_TOTAL
     {
         gamma:"Gamma 1024";
     };
     ...
     LID_BIT VER_LID(NVRAM_EF_CAMERA_DEFECT_LID)
     nvram_camera_defect_struct *NVRAM_EF_CAMERA_DEFECT_TOTAL
     {
     };
 #endif /* defined(ISP_SUPPORT) && (defined(DRV_ISP_6227_SERIES) || defined(DRV_ISP_6229_SERIES) || defined(DRV_ISP_6228_SERIES)) */ 
 #if defined(ISP_SUPPORT) && (defined(DRV_ISP_6227_SERIES) || defined(DRV_ISP_6229_SERIES) || defined(DRV_ISP_6228_SERIES))
     LID_BIT VER_LID(NVRAM_EF_CAMERA_LENS_LID)
     nvram_camera_lens_struct *NVRAM_EF_CAMERA_LENS_TOTAL
     {
     };
 #endif /* defined(ISP_SUPPORT) && (defined(DRV_ISP_6227_SERIES) || defined(DRV_ISP_6229_SERIES) || defined(DRV_ISP_6228_SERIES)) */ 
...
LID_BIT VER_LID(NVRAM_EF_CAMERA_PCA_SUB_BAK1_LID)
 ...
 #endif /* __MMI_PICTURE_EDITOR_SUPPORT__ */ 
 #ifdef __MMI_MESSAGES_CLUB__
     LID_BIT VER_LID(NVRAM_EF_MSG_CLUB_LID)
     nvram_msg_club_struct *NVRAM_MSG_CLUB_RECORD_TOTAL
     {
     };
     LID_BIT VER_LID(NVRAM_EF_MSG_CLUB_NUM_LID)
     nvram_msg_club_num_struct *NVRAM_MSG_CLUB_NUM_RECORD_TOTAL
     {
     };
 #endif /* __MMI_MESSAGES_CLUB__ */ 
...
/* under construction !*/
 ...
 #ifdef __MMI_POC__
     LID_BIT VER_LID(NVRAM_EF_POC_HISTORY_LID)
     kal_uint8 *NVRAM_MAX_POC_HISTORY_TOTAL
     {
     };
     LID_BIT VER_LID(NVRAM_EF_POC_PRIVACY_LID)
     kal_uint8 *NVRAM_MAX_POC_PRIVACY_TOTAL
     {
     };
     LID_BIT VER_LID(NVRAM_EF_POC_PROFILE_LID)
     kal_uint8 *NVRAM_MAX_POC_PROFILE_TOTAL
     {
     };
 #endif /* __MMI_POC__ */ 
     ...
     LID_BIT VER_LID(NVRAM_EF_EONS_INFO_LID)
     kal_uint8 *NVRAM_EF_EONS_INFO_TOTAL
     {
     };
     ...
     LID_BIT VER_LID(NVRAM_EF_MMS_PROFILE_CONTENT_LID)
     nvram_meta_mms_profile_content_struct *NVRAM_EF_MMS_PROFILE_CONTENT_TOTAL
     {
     };
 #endif /* JATAAYU_SUPPORT */ 

 #ifdef __MMI_USER_CTRL_PLMN_SUPPORT__
     LID_BIT VER_LID(NVRAM_EF_USER_CTRL_PLMN_LID)
     kal_uint8* NVRAM_EF_USER_CTRL_PLMN_TOTAL
     {
     };
...
LID_BIT VER_LID(NVRAM_EF_EBOOK_DEFAULT_SETTINGS_LID) nvram_ef_ebook_setting_default_struct* NVRAM_EF_EBOOK_SETTING_TOTAL {};
#endif /* __MMI_EBOOK_READER__ */
    ...
    kal_uint8 *NVRAM_EF_EM_NW_EVENT_RINGS_TOTAL
    {
    };
...
LID_BIT VER_LID(NVRAM_EF_RAC_PREFERENCE_LID)
       ...
       arg1:"PLMN selection mode / Preferred Service in NMO III"
         {
           ...
           plmn_list_pref:4 "PLMN list preference"
             {
               0x0:"ACCURACY First";
               0x1:"SPEED First";
             };
   ...
   {
      pf_rat: 8 "Preferred RAT"
      {
         0x0: "L4C_RAT_NONE";
         0x1: "L4C_RAT_GSM";
         0x2: "L4C_RAT_UMTS";
         0x3: "L4C_RAT_GSM_UMTS (not allowed)";
      };
   };
    ...
    {
      pf_umts_band_1B:8 "3g_preferred_band_1B"
      {		 	    
      };	  
    };
   ...
   preference: "DATA TRANSFER PREFERENCE"
   {
     ...
     pf_gprs_transfer: 4 "gprs transfer preference"
     {
        0x0: "DATA_PREFER";
        0x1: "CALL_PREFER";
        0x2: "AS_OPTIMAL (reserved)";
     };
#else
     unused: 4 "Unused"
     {
     ...
     pf_gprs_transfer: 4 "hspa preference"
     {
        0x0: "HSPA_OFF";
        0x1: "HSDPA_ON";
        0x2: "HSDPA_HSUPA_ON";
...
#ifdef __MMI_LANGLN_LK__
     LID_BIT VER_LID(NVRAM_EF_LANGLN_LK_SETTING_LID)
     nvram_ef_langln_lk_setting_struct *NVRAM_EF_LANGLN_LK_SETTING_TOTAL
     {
     };
#endif /* __MMI_LANGLN_LK__ */ 

#ifdef __MMI_LANGLN__
     LID_BIT VER_LID(NVRAM_EF_LANGLN_PRESEL_INFO_LID)
     nvram_ef_langln_presel_info_struct *NVRAM_EF_LANGLN_PRESEL_INFO_TOTAL
     {
     };
#endif /* __MMI_LANGLN__ */ 

#if defined(__MMI_LANGLN_BK__) || defined(__MMI_LANGLN_SK__)
    LID_BIT VER_LID(NVRAM_EF_LANGLN_BSK_SETTING_LID)
    nvram_ef_langln_sk_setting_struct *NVRAM_EF_LANGLN_BSK_SETTING_TOTAL
     {
     };
#endif /*defined(__MMI_LANGLN_BK__) || defined(__MMI_LANGLN_SK__)*/
...
#if defined(__GPS_SUPPORT__) || defined(__BT_GPS_SUPPORT__)
     LID_BIT VER_LID(NVRAM_EF_GIS_GPS_SETTING_DATA_LID)
     nvram_ef_gis_gps_setting_data_struct *NVRAM_EF_GIS_GPS_SETTING_DATA_TOTAL
     {
     };

     LID_BIT VER_LID(NVRAM_EF_TIME_SYNC_SETTING_LID)
     nvram_ef_time_sync_setting_struct *NVRAM_EF_TIME_SYNC_SETTING_TOTAL
     {
     };
#endif /* defined(__GPS_SUPPORT__) || defined(__BT_GPS_SUPPORT__) */ 
...
*/         
     ...
     LID_BIT VER_LID(NVRAM_EF_AGPS_SEND_LOCATION_LID)
     nvram_ef_agps_send_location_struct *NVRAM_EF_AGPS_SEND_LOCATION_TOTAL
     {
     };
...
#endif /* defined(__MMI_BT_AUTO_PROMPT_SWITCH__) */ 
...
//#ifndef __PHB_NO_CALL_LOG__
#if defined(__MMI_OP11_HOMESCREEN__) || defined(__MMI_OP12_TOOLBAR__) || defined(__MMI_VUI_HOMESCREEN__)
	 LID_BIT VER_LID(NVRAM_EF_CHIST_MISS_ACCUM_TIMES_LID)
     nvram_ef_chist_miss_accum_times_struct *NVRAM_EF_CHIST_MISS_ACCUM_TIMES_TOTAL
     {
     };

	 LID_BIT VER_LID(NVRAM_EF_CHIST_MISS_EVENT_CHECK_LID)
     nvram_ef_chist_miss_event_check_struct *NVRAM_EF_CHIST_MISS_EVENT_CHECK_TOTAL
     {
     };
#endif /* defined(__MMI_OP11_HOMESCREEN__) || defined(__MMI_OP12_TOOLBAR__) || defined(__MMI_VUI_HOMESCREEN__) */
// #endif /* __PHB_NO_CALL_LOG__ */
...
#if defined (__PS_SERVICE__) && defined (__MOD_TCM__) && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)
LID_BIT VER_LID(NVRAM_EF_TCM_EXT_CALL_HISTORY_LID)
     nvram_ef_tcm_ext_call_history_struct *NVRAM_EF_TCM_EXT_CALL_HISTORY_TOTAL
     {
        call_history_total_ext_tx_data:"Total external PS call tx data"
        {
        }; 
        call_history_total_ext_rx_data:"Total external PS call rx data"
        {
        };
        call_history_last_ext_tx_data:"Last (certain context id) external PS call tx data"
        {
        };
        call_history_last_ext_rx_data:"Last (certain context id) external PS call rx data"
        {
        };
        call_history_total_ext_conn_duration:"Total external PS call duration summation"
        {
        };
        call_history_last_ext_conn_duration:" Last (certain context id) external PS call duration"
        {
        };
     };
#endif // ~ #if defined (__PS_SERVICE__) && defined (__MOD_TCM__) && defined (__TCM_EXT_CALL_HISTORY_SUPPORT__)
...
#ifdef __TCPIP__
    /* CBM call history */
    LID_BIT VER_LID(NVRAM_EF_CBM_CALL_HISTORY_LID)
    nvram_ef_cbm_tcp_history_struct *NVRAM_EF_TCP_LAST_TOTAL_TOTAL
    {
    };
#endif
#endif
     ...
     LID_BIT VER_LID(NVRAM_EF_ABM_PS_QOS_PROFILE_LID)
     nvram_ef_abm_ps_qos_profile_struct *NVRAM_EF_ABM_PS_QOS_PROFILE_TOTAL
     {
     };
#endif /* __PS_SERVICE__ */ 
#ifdef __MMI_AZAAN_ALARM__
    LID_BIT VER_LID(NVRAM_EF_AZAAN_ALARM_LID)
     nvram_alm_alarm_data_struct *NVRAM_AZAAN_ALARM_TOTAL
     {
     };
...
#endif /* __SRV_SMS_SIM_CUST_DATA__ */
LID_BIT VER_LID(NVRAM_EF_DTCNT_APP_INFO_LID)
nvram_ef_dtcnt_app_info_nvram_struct * NVRAM_MAX_DTCNT_APP_INFO_TOTAL
{
};
...
LID_BIT VER_LID(NVRAM_EF_AUDIO_BESLOUDNESS_LID)
