...
//set PSI_EE to 6499
//set C_PSI_STA to 283
#endif
#ifdef AFC_13bit
/* Due to 13bits DAC */
    #if defined(AFC_VCXO) /*VCXO*/
#define  PSI_EE               (6499) //(4100)            /* DAC initial value */
    #else                 /*VCTCXO*/
#define  PSI_EE               (6499) //(4500)            /* DAC initial value */
    #endif
#define  AFC_DP_MIN           (0)
...
/*MT6119/C,MT6129A/B/C/D*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=3.2  */
/*MT6119/C,MT6129A/B/C/D*/ #else
/*MT6119/C,MT6129A/B/C/D*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
...
/*MT6139E*/ #define  C_PSI_STA      (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=7    */
/*MT6139E*/ #else
/*MT6139E*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*MT6139E*/ #endif
/*MT6139E*/
...
/*MT6140D*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=7    */
/*MT6140D*/    #else                 /*VCTCXO*/
/*MT6140D*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=3    */
/*MT6140D*/    #endif
/*MT6140D*/ #else
/*MT6140D*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*MT6140D*/ #endif
/*MT6140D*/
...
/*MTKSOC1*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=4.511  */
/*MTKSOC1*/ #else
/*MTKSOC1*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*MTKSOC1*/ #endif
...
/*MT6252RF*/ #ifdef AFC_13bit  // (4096)/(14.4735) = 282.999 = 283
/*MT6252RF*/ #define  C_PSI_STA     (283) //(1170)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=4.511    */ //ZZZZZ
/*MT6252RF*/ #else
/*MT6252RF*/ #define  C_PSI_STA     (283) //(146)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*MT6252RF*/ #endif
...
/*AD6548*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=7    */
/*AD6548*/    #else                 /*VCTCXO*/
/*AD6548*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=3    */
/*AD6548*/    #endif
/*AD6548*/ #else
/*AD6548*/ #define  C_PSI_STA     (283)   /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*AD6548*/ #endif
/*AD6548*/
...
/*AD6546*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=7    */ 
/*AD6546*/    #else                 /*VCTCXO*/
/*AD6546*/ #define  C_PSI_STA     (283) /* C_PSI_STA= sta^(-1)  * (2^12), sta=3    */
/*AD6546*/    #endif
/*AD6546*/ #else
/*AD6546*/ #define  C_PSI_STA     (283)  /* C_PSI_STA= sta^(-1)  * (2^12), sta=28.05  */
/*AD6546*/ #endif
/*AD6546*/
