...
/*initialize mms class as informational in lemei mms.*/
 ...
 /* </header> */
    ...
    #if defined(__LEIFAYU__)
        {
            ...
            extern U32 drv_get_current_time(void);
            ...
            kal_wsprintf(path, "%c:\\_%d.xml", drive, drv_get_current_time());
            FS_Move((const WCHAR*)file_path, path, FS_MOVE_COPY|FS_MOVE_OVERWRITE, NULL, 0, 0);
        }
    #endif
    }
    else
